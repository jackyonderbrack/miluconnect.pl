    ...
    <>
      ...
      />
        <section className="content background-top pt-4">
            <h4>Wstęp</h4>
            <p>
            Niniejsza polityka prywatności opisuje, w jaki sposób miluConnect gromadzi, wykorzystuje i chroni Twoje dane osobowe, które nam przekazujesz podczas korzystania z naszej strony internetowej [miluConnect.com].
            </p>
            ...
            <p>
                W celu skorzystania z tych praw prosimy o kontakt z nami pod adresem email: [miluConnect@gmail.com].
            </p>
