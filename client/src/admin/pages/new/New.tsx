...
import { User, addUser } from "../../services/user.service";
import { Post, addPost } from "../../services/post.service"
            ...
            <div key={field.name} className="form-new form-group">
              ...
              <div className="form-inputs">
                {field.type === "textarea" ? (
                  ...
                  <input type={field.type} id={field.name} name={field.name} onChange={handleChange} />
                )}  
              </div>
            </div>
          ))}
